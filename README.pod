...
=item * <ctrl>y to redo said deletions
...
=item    * loading of transcript text & other metadata, such as text-audio spacetime anchors.

=item    * a stack of transcription spacetime contexts.

=item    * saved audio position in text location. (spacetime)
